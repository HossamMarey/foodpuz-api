...
import { gameTemplateController, gameTemplateQueryMiddleware } from '../controllers/gameTemplate.controller';

const router = express.Router();

// Game Template Routes
router.post('/templates', authenticate, gameTemplateController.createGameTemplate);
router.get('/templates/organization/:organizationId', authenticate, checkOrganizationMembership, gameTemplateQueryMiddleware, gameTemplateController.getOrganizationGameTemplates);
